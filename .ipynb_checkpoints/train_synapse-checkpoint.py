...
if __name__ == "__main__":
    ...
    snapshot_path = "/dss/dssfs04/lwp-dss-0002/pn36fu/pn36fu-dss-0000/reza/sina/model_pth_emcad_moga_deep/{}/{}".format(args.exp, args.encoder + '_EMCAD_kernel_sizes_' + str(args.kernel_sizes) + '_dw_' + dw_mode + '_' + aggregation + '_lgag_ks_' + str(args.lgag_ks) + '_ef' + str(args.expansion_factor) + '_act_mscb_' + args.activation_mscb + '_loss_' + args.supervision + '_output_final_layer_Run'+str(run))
